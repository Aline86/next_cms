  ...
  return bloc !== undefined ? (
      ...
      className={
        full
          ? isResponsive
            ...
            : result?.matches
            ? "relative min-h-[100vh] w-[80vw] flex flex-col align-center justify-center m-auto mt-16 border-1 border-gray-300 p-4 rounded-sm"
            : "relative min-h-[80vh] w-[80vw] flex align-center justify-center m-auto mt-24 border-1 border-gray-300 p-4 rounded-sm"
    ...
    >
      ...
      >
        ...
        >
          {external === "External link" || external === "Mailto" ? (
            <a
              key={String(bloc.id)}
              href={
              ...
              className={
                result?.matches || isResponsive
                  ? "relative top-2/3 m-auto block w-fit  h-[40px] bg-gray-800 rounded-sm text-white"
                  : !full
