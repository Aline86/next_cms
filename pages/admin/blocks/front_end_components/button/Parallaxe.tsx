      ...
      >
        {external === "External link" || external === "Mailto" ? (
          <a
            ...
            target="_blank"
            className={
              "absolute absolute top-2/3 left-1/2 transform -translate-x-1/2 -translate-y-1/3 block w-[270px] bg-[rgba(0,0,0,0.2)] h-[40px] border-1 border-gray-100 rounded-sm text-white"
            }
          >
            {"button_text" in bloc &&
